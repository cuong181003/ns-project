   ...
   public final void paint(mGraphics var1) {
      if (this.type == 1) {
         if (GameCanvas.gameTick % 5 > 2) {
            SmallImage.drawSmallImage(var1, 1433, this.x, this.y, 0, 3);
         } else {
            SmallImage.drawSmallImage(var1, 1434, this.x, this.y, 0, 3);
         }
      } else {
         for(int var2 = 0; var2 < this.x0.length; ++var2) {
            if (GameCanvas.gameTick % 5 > 2) {
               SmallImage.drawSmallImage(var1, 1433, this.x0[var2], this.y0[var2], 0, 3);
            } else {
               SmallImage.drawSmallImage(var1, 1434, this.x0[var2], this.y0[var2], 0, 3);
            }
         }
